...
if salb <= 900:
    ...
    print('Total de descontos: R$ ', inss + fgts + sindicato)
    print('Salário Liquido:', salb - (inss + fgts + sindicato))
    ...
    print('FGTS (11%): R$ ', fgts)
    print('Sindicato (3%): R$ ', sindicato)
    print('Total de descontos: R$ ', inss + fgts + sindicato + ir)
    print('Salário Liquido:', salb - (inss + fgts + sindicato + ir))
